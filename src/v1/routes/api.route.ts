...
import productMovementRoute from "@/routes/productMovement.route";
...
apiRoute.use(`/${routeVersion}/orders`, protect, orderRoute);
apiRoute.use(`/${routeVersion}/order-items`, protect, orderItemRoute);
apiRoute.use(`/${routeVersion}/products`, protect, productRoute);
apiRoute.use(`/${routeVersion}/product-movements`, protect, productMovementRoute);
