...
import { getDashboardRooms as getDashboardRoomsService } from "@/services/dashboard.service";
 ...
 * @returns
 */
export const getDashboardRooms = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const user = req.user!;
