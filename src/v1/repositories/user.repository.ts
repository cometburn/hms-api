...
export class UserRepository {
     ...
     */
    updateUserRefreshToken = async (userId: number, refreshToken: string): Promise<void> => {
     ...
     */
    getUserByIdAndRefreshToken = async (
        userId: number,
        refreshToken: string
    ): Promise<User | null> => {
     ...
     */
    getUserHotels = async (userId: number): Promise<UserHotelResponse[]> => {
     ...
     */
    getUserByIdWithDefaultHotel = async (id: number) => {
     ...
     * @returns user
     */
    createGoogleUserWithTrial = async (data: CreateGoogleUserInput) => {
