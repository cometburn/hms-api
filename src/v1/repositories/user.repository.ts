 ...
 */
export const updateUserRefreshToken = async (userId: number, refreshToken: string): Promise<void> => {
 ...
 */
export const getUserHotels = async (userId: number): Promise<UserHotelResponse[]> => {
 ...
 * @returns user
 */
export const createGoogleUserWithTrial = async (data: CreateGoogleUserInput) => {
